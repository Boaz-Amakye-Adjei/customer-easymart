...
export default function SacheteGoods() {
  return (
    <section className="px-10">
      <Sort />
      <div className="my-5 mb-15">
        <h1 className="text-center mb-2 font-bold text-3xl">Sachete Goods</h1>
        <p className="text-center text-gray-400 text-xs">
          Get your favourite sachete goods from your favourite brands
        </p>
      </div>
  ...
  return (
    <div className="bg-gray-100 rounded-md w-full h-fit">
      <div className="h-[180px] grid place-content-center">
        <Image src="/cerelac.png" width={170} height={170} alt="Bread" />
      </div>
