...
export default function MeatAndEggs() {
  return (
    <section className="px-10">
      <Sort />
      <div className="my-5 mb-15">
        <h1 className="text-center mb-2 font-bold text-3xl">Meat and Eggs</h1>
        <p className="text-center text-gray-400 text-xs">
          Get your meat and fresh eggs from EasyMart
        </p>
      </div>
  ...
  return (
    <div className="bg-gray-100 rounded-md w-full h-fit">
      <div className="h-[180px] grid place-content-center">
        <Image src="/crate-of-eggs.png" width={170} height={170} alt="Bread" />
      </div>
